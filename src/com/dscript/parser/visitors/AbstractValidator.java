...
public abstract class AbstractValidator implements Visitor {
    ...
    @Override
    public void visit(OutStatement s) {
        s.expression.accept(this);
    }

    @Override
    public void visit(OutlineStatement s) {
        s.expression.accept(this);
    }
    ...
    @Override
    public void visit(UsesStatement s) {
        s.expression.accept(this);
    }
