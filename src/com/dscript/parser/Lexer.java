...
private static final String OPERATOR_CHARS = "+-*/%(){}[]=<>!&|,;";
    ...
    private void tokenizeNumber() {
        ...
        while (true) {
            if (current == '.') {
                if (buffer.indexOf(".") != -1) throw new RuntimeException("Error: invalid float number!");
    ...
    private void tokenizeWord() {
        ...
        switch(word) {
            case "out": addToken(TokenType.OUT); break;
            case "outline": addToken(TokenType.OUTLINE); break;
            ...
            case "uses": addToken(TokenType.USES); break;
            //case "in": addToken(TokenType.IN); break;
            default:
    ...
    private void tokenizeMultilineComment() {
        char current = peek(0);
        while(true) {
            if(current == '\0') throw new RuntimeException("Error: missing close tag!");
